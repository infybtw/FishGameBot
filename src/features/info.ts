...
const INFO_TEXT =
  ...
  `Ловите рыбу в групповых чатах, продавайте улов и улучшайте удочки.\n\n` +
  `<b>Команды:</b>\n` +
  `/fish — попытка поймать рыбу\n` +
  `/net — забросить или забрать рыбацкую сеть\n` +
  `/profile — инвентарь и удочки\n` +
  `/fishtop — топ по стоимости инвентаря\n` +
  `/fishtop_text — текстовая версия топа\n` +
