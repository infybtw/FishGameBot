...
- Fish collections by rarity and theme: hand in the required copies of every listed fish (some need several) to earn a permanent unique bonus
...
| `/collections` | Open your personal collections menu. Hand in the required copies of every required fish (rarity groups and themed sets, some needing several identical fish) to complete a collection and permanently gain its unique bonus (catch chance, rarity, modifier chance, or fish price). |
